...
class Position(Worker):
    ...
    def get_total_income(self):
        return int(sum(self._income.values()))


worker1 = Position('Oleg', 'Ivanov', 'CEO', 125000, 19000)
print(worker1.get_full_name(), worker1.position, worker1.get_total_income())

worker2 = Position('Ivan', 'Olegov', 'COO', 122000, 18000)
print(worker2.get_full_name(), worker2.position, worker2.get_total_income())
